...
$H_A: \mu_Denver} ≠ \mu_{Minneapolis}$. The true mean daily proportional difference in number of violent offenses between the June 2020 to May 2021 time period compared to the June 2019 to May 2020 time period in Denver, CO is not equal to the true mean daily proportional difference in number of violent offenses between the two time periods in Minneapolis
...
In terms of absolute differences, however, the high p-value of 0.204 is well above an alpha level of 0.01, meaning we cannot reject the null hypothesis. The data does not provide significant evidence that Minneapolis' daily average absolute increase in violent crime was not equal to Denver's daily average absolute increase in violent crime between the two periods. However, we would like to caution that the use of raw absolute data may not tell the full story, since Minneapolis began with a lower number of violent offenses per day, meaning the increase is proportionately much greater than in Denver.
