...
P-value is greater than any reasonable alpha level of 0.05, 0.01, or even 0.1, indicating data does not provide statistically significant evidence that Fort Smith's average daily in violent crime was different from Denver's increase between the two time intervals.
