...
test_results <- SCtools::mspe.test(placebos2)$test
SCtools::mspe.test(placebos2, discard.extreme = TRUE, mspe.limit = 5)$p.val
```
...
# Results in too few for analysis - roughly only 18 observations because fit for 2016-2019 is incredible for Aurora.
```
...
test_property_prep <- dataprep(foo = reduced_database_violent, predictors = 
         ...
         predictors.op = "mean", dependent = "property_crime_rate", unit.variable = 
         "id", time.variable = "year", unit.names.variable = "NAME", 
         treatment.identifier = 67, controls.identifier = c(1:4, 6:9, 11:19, 21:24, 26:66, 68:93, 
                                                            95:96), 
         time.predictors.prior = 2011:2020, time.optimize.ssr = 2016:2019, 
         time.plot = 2011:2021)
...
Ylab = c("Violent Crime Rates"),
Xlab = c("Year"),
Legend = c("Oceanside, CA","Synthetic Oceanside")
)
