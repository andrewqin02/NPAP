...
denver_violent_prep <- dataprep(foo = reduced_database_violent, predictors = 
         ...
         predictors.op = "mean", dependent = "violent_crime_rate", unit.variable = 
         "id", time.variable = "year", unit.names.variable = "NAME", 
         treatment.identifier = 26, controls.identifier = c(1:4, 6:9, 11:19, 21:25, 27:34, 
                                                            36:91, 93:99, 101:102), 
...
cspd_violent_prep <- dataprep(foo = reduced_database_violent, predictors = 
         ...
         predictors.op = "mean", dependent = "violent_crime_rate", unit.variable = 
         "id", time.variable = "year", unit.names.variable = "NAME", 
         treatment.identifier = 20, controls.identifier = c(1:4, 6:9, 11:19, 21:25, 27:34, 
                                                            36:91, 93:99, 101:102), 
...
aurora_violent_prep <- dataprep(foo = reduced_database_violent, predictors = 
         ...
         predictors.op = "mean", dependent = "violent_crime_rate", unit.variable = 
         "id", time.variable = "year", unit.names.variable = "NAME", 
         treatment.identifier = 5, controls.identifier = c(1:4, 6:9, 11:19, 21:25, 27:34, 
                                                            36:91, 93:99, 101:102), 
...
```{r gen-placebos}
placebos2 <- generate.placebos(denver_property_prep, synth_denver_property) ## Placebos
saveRDS(placebos2, 
       file = "/Users/andrewqin02/Desktop/R/NPAP/data/placebos2.Rdata")
```

```{r denver-placebo-results}
test_results <- mspe.test(placebos2)$test
mspe.test(placebos2, discard.extreme = TRUE, mspe.limit = 5)$p.val
```
