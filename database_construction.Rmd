...
```{r gen-placebos}
placebos7 <- generate.placebos(denver_violent_prep, synth_denver_violent) ## Placebos
saveRDS(placebos7, 
       file = "/Users/andrewqin02/Desktop/R/NPAP/data/placebos7.Rdata")

placebos8 <- generate.placebos(denver_property_prep, synth_denver_property)
saveRDS(placebos8, 
       file = "/Users/andrewqin02/Desktop/R/NPAP/data/placebos8.Rdata")

```

```{r denver-placebo-results}
test_results <- SCtools::mspe.test(placebos7)$test
SCtools::mspe.test(placebos7, discard.extreme = TRUE, mspe.limit = 5)$p.val
```
