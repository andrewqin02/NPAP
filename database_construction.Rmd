...
```{r}
prep <- dataprep(foo = no_colorado1, predictors = c("population", "female_household", 
...
```{r prep-co-springs}
prep_cosprings <- dataprep(foo = no_colorado1, predictors = c("population", "female_household", 
                                                "hs", "res_stability", "over_18", 
                                                "white_percent", "self_employed", 
                                                "unemployment", "median_income", 
                                                "child_poverty", "owner_occupied"), 
         predictors.op = "mean", dependent = "violent_crime_rate", unit.variable = 
         "id", time.variable = "year", unit.names.variable = "NAME", 
         treatment.identifier = 185, controls.identifier = c(1:184, 187:514), 
         time.predictors.prior = 2011:2019, time.optimize.ssr = 2014:2019, 
         time.plot = 2011:2019)
```
...
reduced_database_property <- reduced_database %>% 
  filter(is.na(property_crime_rate) == FALSE & is.na(violent_crime_rate) == FALSE
...
denver_prop_prep <- dataprep(foo = no_colorado1, predictors = c("population", "female_household", 
         ...
         "id", time.variable = "year", unit.names.variable = "NAME", 
         treatment.identifier = 186, controls.identifier = c(1:184, 187:507), 
         time.predictors.prior = 2011:2019, time.optimize.ssr = 2016:2019, 
         time.plot = 2011:2019)
...
cspd_prop_prep <- dataprep(foo = no_colorado1, predictors = c("population", "female_household", 
         ...
         predictors.op = "mean", dependent = "property_crime_rate", unit.variable = 
         "id", time.variable = "year", unit.names.variable = "NAME", 
         treatment.identifier = 185, controls.identifier = c(1:184, 187:507), 
         time.predictors.prior = 2011:2019, time.optimize.ssr = 2016:2019, 
         time.plot = 2011:2019)
...
```{r}
weights_cspd_prop <- synth_cspd_property$solution.w
...
```{r}
diagnostics <- anti_join(no_colorado2, no_colorado1, by = c("state", "city", "year"))
diagnostics2 <-  anti_join(no_colorado1, no_colorado2, by = c("state", "city", "year"))
```
...
```{r}
cspd_prop_prep$X0 <- cspd_prop_prep$X0[,colSums(cspd_prop_prep$X0 != 0) != 0]
cspd_prop_prep$X1 <- cspd_prop_prep$X1[,colSums(cspd_prop_prep$X1 != 0) != 0]
cspd_prop_prep$Z0 <- cspd_prop_prep$Z0[,colSums(cspd_prop_prep$Z0 != 0) != 0]
cspd_prop_prep$Z1 <- cspd_prop_prep$Z1[,colSums(cspd_prop_prep$Z1 != 0) != 0]
...
cspd_prop_prep <- dataprep(foo = no_colorado2, predictors = c("population", "female_household", 
         ...
         predictors.op = "mean", dependent = "property_crime_rate", unit.variable = 
         "id", time.variable = "year", unit.names.variable = "NAME", 
         treatment.identifier = 189, controls.identifier = c(1:188, 191:521), 
         time.predictors.prior = 2012:2019, time.optimize.ssr = 2016:2019, 
         time.plot = 2012:2019)
