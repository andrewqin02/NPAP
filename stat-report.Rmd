...
We began by visualizing monthly violent crime and property crime numbers in both Denver and Colorado Springs.
...
```{r create-synthetic-control-raw-numbers, fig.height = 4, fig.width = 5}
...
```{r create-synthetic-control-property, fig.height = 4, fig.width = 5}
...
ggplot(synthetic_control_graph2, aes(x = my, y = n, color = jurisdiction)) + 
  ...
  labs(title = "Denver vs Control Monthly Property Crime Numbers", 
       ...
       color = "Jurisdiction") + 
  ylim(0, 3800) +
  theme(text = element_text(size = 9)) # Begins deviating significantly (going above control) at June - perhaps move the red line to prevent confusion? Happened halfway through June
```
...
ggplot(combined_synthetic_violent, aes(y = diff, x = date, color = jurisdiction)) + 
  ...
  theme_bw() + 
  labs(title = "Denver Daily Violent Crime Increases vs Control Increases", 
...
ggplot(combined_synthetic_property, aes(y = diff, x = date, color = jurisdiction)) + 
  ...
  geom_smooth() + 
  theme_bw() + 
  labs(title = "Denver Daily Property Crime Increases vs Control Increases", 
       y = "Proportional Daily Differences", 
       x = "2020-21 Date", 
       color = "Jurisdiction") +
  theme(text = element_text(size = 9))
...
```{r denver-violent-crime-synth-plot, fig.height = 4, fig.width = 5}
...
```{r denver-violent-crime-true-synth-plot, fig.height = 4, fig.width = 5}
...
```{r denver-property-crimes-synthetic-control-graph, fig.height = 4, fig.width = 5}
...
```{r denver-property-crimes-synthetic-control-graph-true, fig.height = 4, fig.width = 5}
